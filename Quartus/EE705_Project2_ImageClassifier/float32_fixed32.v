...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=16 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clock dataa result
...
module  float32_fixed32_altbarrel_shift_g4h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //float32_fixed32_altbarrel_shift_g4h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 282 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  float32_fixed32_altfp_convert_e0n
	( 
	clock,
	dataa,
	result) ;
	...
	float32_fixed32_altbarrel_shift_g4h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //float32_fixed32_altfp_convert_e0n
//VALID FILE
...
module float32_fixed32 (
	...
	float32_fixed32_altfp_convert_e0n	float32_fixed32_altfp_convert_e0n_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
